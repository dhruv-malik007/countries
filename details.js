$(document).ready(function(){
    ...
    detail_text.innerHTML += ('<p class="m-0 ">Native Name :'+country2[0].name.common +'</p>');
    detail_text.innerHTML += ('<p class="m-0 ">Capital :'+country2[0].capital +'</p>');
    detail_text.innerHTML += ('<p class="m-0 ">Population :'+country2[0].population +'</p>');
    detail_text.innerHTML += ('<p class="m-0 ">Region :'+ country2[0].region+'</p>');
    detail_text.innerHTML += ('<p class="m-0 ">Sub-Region :'+country2[0].subregion +'</p>');
    detail_text.innerHTML += ('<p class="m-0 ">Area :'+country2[0].area +' KM<sup>2</sup></p>');
    detail_text.innerHTML += ('<p class="m-0 ">Country Code :'+country2[0].idd.root + country2[0].idd.suffixes +'</p>');
    detail_text.innerHTML += ('<p class="m-0 ">Languages :');
    ...
    detail_text.innerHTML += ('<p class="m-0 ">Currencies :'+currencyName1 +'</p>');
    detail_text.innerHTML += ('<p class="m-0 ">Time Zone :'+country2[0].timezones +'</p>');
